...
extern int sw49407_sic_abt_is_set_func(void);
extern void sw49407_sic_abt_probe(void);
extern void sw49407_sic_abt_remove(void);
extern void sw49407_sic_abt_init(struct device *dev);
extern int sw49407_sic_abt_is_debug_mode(void);
extern int sw49407_sic_abt_irq_handler(struct device *dev);
extern void sw49407_sic_abt_ocd_off(struct device *dev);
extern void sw49407_sic_abt_onchip_debug(struct device *dev, u8 *all_data);
