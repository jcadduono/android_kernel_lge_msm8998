...
/* refer from android/bootable/bootloader/edk2/QcomModulePkg/Library/LGESharedLib/include/lge_ftm.h */
...
static const char *ftmdev = "/dev/block/bootdevice/by-name/ftm";
...
int set_carrier_code(unsigned long int in)
{
	...
	printk("set_carrier_code %d", (int)in);
...
int get_carrier_code(void)
{
	...
	printk("get_carrier_code = %d", (int)carrier_code);
