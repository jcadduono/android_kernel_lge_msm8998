...
/* 2016-07-19 jewon.lee@lge.com, LGP_DATA_TCPIP_MPTCP [START] */
        ...
        // Fix WBT #183655, #183656, #183657, #183658
        if (ind == -1) {
            rcu_read_unlock();
            return;
        }

        ifa_address = mptcp_local->locaddr4[ind].addr.s_addr;
