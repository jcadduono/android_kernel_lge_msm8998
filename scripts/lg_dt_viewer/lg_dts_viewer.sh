...
usage() {
    ...
    echo "./scripts/lg_dt_viewer/lg_dts_viewer.sh arch/arm64/boot/dts/lge/msm8998-lucy_kr/msm8994-lucy_kr_rev-a.dts"
    echo "or"
    echo "./scripts/lg_dt_viewer/lg_dts_viewer.sh arch/arm64/boot/dts/lge/msm8998-lucy_kr/"
    exit
}
